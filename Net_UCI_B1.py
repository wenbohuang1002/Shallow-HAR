...
# print(cm)
# np.save('Store/UCI/confusion_matrix_b.npy',cm)
# np.save('Store/UCI/epoch_r.npy',epoch_list)
# np.save('Store/UCI/accuracy_r.npy',accuracy_list)
# np.save('Store/UCI/loss_r.npy',loss_list)
torch.save(net,'Mobile/deep.pth')
