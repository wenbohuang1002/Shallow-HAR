...
# np.save('Store/Unimib/epoch_baseline.npy',epoch_list)
# np.save('Store/Unimib/accuracy_baseline.npy',accuracy_list)
# np.save('Store/Unimib/loss_baseline.npy',loss_list)
