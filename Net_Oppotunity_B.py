...
for epoch in range(2000):
    ...
    if epoch%1==0:
            ...
            #     # print(cm)
            #     # np.save('Store/Oppotunity/confusion_matrix_b.npy',cm)
            # else:
            #     continue
...
# cm = sm.confusion_matrix(pred_y.cpu().numpy(), flat(test_y.float()).cpu().numpy())
# print(cm)
# np.save('Store/Oppotunity/epoch_baseline.npy',epoch_list)
# np.save('Store/Oppotunity/accuracy_baseline.npy',accuracy_list)
# np.save('Store/Oppotunity/loss_baseline.npy',loss_list)
