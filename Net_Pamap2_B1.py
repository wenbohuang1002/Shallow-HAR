...
np.save('Store/Pamap2/epoch_r.npy',epoch_list)
np.save('Store/Pamap2/accuracy_r.npy',accuracy_list)
np.save('Store/Pamap2/loss_r.npy',loss_list)


model = Net_SC()
stat(model, (86, 120, 1))

# Total params: 2,935,308
# ----------------------------------------------------------------------------------------------------------------------------------------------
# Total memory: 0.28MB
# Total MAdd: 47.15MMAdd
# Total Flops: 23.6MFlops
# Total MemR+W: 11.66MB
