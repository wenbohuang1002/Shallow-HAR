...
# print(cm)
# np.save('Store/Unimib_R1/confusion_matrix_b.npy',cm)
# np.save('Store/Unimib/epoch_r.npy',epoch_list)
# np.save('Store/Unimib/accuracy_r.npy',accuracy_list)
# np.save('Store/Unimib/loss_r.npy',loss_list)
